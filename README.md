# MOSFET Stack-Level Material Selector
...
```
3. Open the notebooks in `notebooks/` folder using Jupyter or VS Code.
...
> Y. Fu, F. Liu, Z. He, Q. Lin, and T. H. Teo, "A Quantitative Framework for Layer-Wise Material Selection in MOSFETs Using Priority-Aware Property Mapping," 2025.
